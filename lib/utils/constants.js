export default {
  ...
  // it does not throw - it quietly becomes 1 ms. refreshRate and cloudRefreshRate
  // are already capped at 600 further down, but the garage opening time was not,
  // so a large value made the door's reset timer fire immediately and repeatedly.
  maxValues: {
    garageDoorOpeningTime: 2073600,
  },
  ...
  models: {
    ...
    roller: ['MRS100', 'MRS105', 'MRS200'],
    baby: ['HP110A', 'HP110AHK'],
    thermostat: ['MTS200', 'MTS200B', 'MTS205', 'MTS205B', 'MTS960'],
    thermostatMts300: ['MTS300'],
    thermostatMts215: ['MTS215', 'MTS215B'],
    sensorPresence: ['MS600'],
    hubMain: ['MSH300', 'MSH300HK', 'MSH400', 'MSH450'],
    hubSub: ['GS559A', 'MA151', 'MS100', 'MS100F', 'MS130', 'MS130H', 'MS200', 'MS400', 'MST100', 'MST200', 'MTS100', 'MTS100V3', 'MTS150', 'MTS150P'],
    template: [],
  },
  ...
  hkNativeHardware: {
    ...
    MTS200: ['7'],
    MTS200B: ['7'],
    PSX340: ['4'], // https://github.com/homebridge-plugins/homebridge-meross/issues/783
    SP425EW: ['4'], // MSS425E
    MSH300HK: ['4', '5'],
  },
